...
#define dgone_half 0.5
#define dgsmall_number 1.e-12
#define dgtiny_number 1.e-20
#define dgfour_gamma_squared 5.8284273147583007813
...
// )
// {
// 	d_un Sa11, Sa21, Sa31, Sa12, Sa22, Sa32, Sa13, Sa23, Sa33;
// 	d_un Su11, Su21, Su31, Su12, Su22, Su32, Su13, Su23, Su33;
// 	d_un Sv11, Sv21, Sv31, Sv12, Sv22, Sv32, Sv13, Sv23, Sv33;
// 	d_un Sc, Ss, Sch, Ssh;
// 	d_un Stmp1, Stmp2, Stmp3, Stmp4, Stmp5;
// 	d_un Ss11, Ss21, Ss31, Ss22, Ss32, Ss33;
// 	d_un Sqvs, Sqvvx, Sqvvy, Sqvvz;
...
// 		Stmp2.f = Ssh.f * Ssh.f;
// 		Stmp1.ui = (Stmp2.f >= dgtiny_number) ? 0xffffffff : 0;
// 		Ssh.ui = Stmp1.ui & Ssh.ui;
// 		Sch.ui = Stmp1.ui & Stmp5.ui;
// 		Stmp2.ui = ~Stmp1.ui & gone;
// 		Sch.ui = Sch.ui | Stmp2.ui;
...
// 		Ssh.f = Stmp4.f * Ssh.f;
// 		Sch.f = Stmp4.f * Sch.f;
// 		Stmp1.f = dgfour_gamma_squared * Stmp1.f;
// 		Stmp1.ui = (Stmp2.f <= Stmp1.f) ? 0xffffffff : 0;
...
// 	Ssh.f = Sa21.f * Sa21.f;
// 	Ssh.ui = (Ssh.f >= dgsmall_number) ? 0xffffffff : 0;
// 	Ssh.ui = Ssh.ui & Sa21.ui;

// 	Stmp5.f = 0.0;
// 	Sch.f = __dsub_rn(Stmp5.f, Sa11.f);
// 	Sch.f = max(Sch.f, Sa11.f);
// 	Sch.f = max(Sch.f, dgsmall_number);
// 	Stmp5.ui = (Sa11.f >= Stmp5.f) ? 0xffffffff : 0;
