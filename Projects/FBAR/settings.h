...
constexpr int g_device_cnt = 2; //< IMPORTANT. Num. GPUs to compile for. Default 1.
...
constexpr std::size_t g_max_halo_block = 1024 * 3; //< Max active halo blocks. Preallocated, can resize.
