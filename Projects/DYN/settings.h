...
constexpr std::array<size_t, 5> g_max_particle_num_arr = {100000, 9000, 10, 10, 10};
constexpr int g_max_active_block = 4000; /// 62500 bytes for active mask
constexpr std::array<size_t, 5> g_max_active_block_arr = {3000, 500, 10000, 10000, 10000};
...
//constexpr std::array<size_t, 5> g_max_particle_bin_arr = g_max_particle_num_arr / g_bin_capacity; //< Max particle bins (#)
