...
constexpr int g_max_particle_num = 4600000; // Particle upperbound
constexpr int g_max_active_block = 24000;  /// 62500 bytes for active mask
...
constexpr int g_target_cells = 14000; //< Max nodes in grid-cell target
