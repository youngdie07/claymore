...
// Domain size
#define DOMAIN_VOLUME 8.f //884736.f //< g_length^3, IMPORTANT, scales mass-volume
constexpr float g_length   = 2.f;//96.f; //< Domain full length (m)
constexpr float g_length_x = 2.f;//96.f; //< Domain x length (m)
...
constexpr int g_max_particle_num = 50000; // 8000000
constexpr int g_max_active_block = 1000; //5000; /// 62500 bytes for active mask
...
constexpr int g_max_fem_vertice_num = 2673;//425; //3636;  // Max no. of vertice on FEM mesh
constexpr int g_max_fem_element_num = 10240;//1280; //12500; // Max no. of element in FEM mesh
constexpr int g_max_fem_element_bin = 10240;//1280; //12500; // Max no. of element in FEM mesh
