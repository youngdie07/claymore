...
constexpr int g_max_particle_num = 2700000; // 8000000
constexpr int g_max_active_block = 42000; //5000; /// 62500 bytes for active mask
...
constexpr int g_max_fem_element_bin = 85671; // 784519; // Max no. of element in FEM mesh
