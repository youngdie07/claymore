...
// Domain size
#define DOMAIN_VOLUME 0.262144f //< g_length^3, IMPORTANT, scales mass-volume
constexpr float g_length   = 0.64f; //< Domain full length (m)
constexpr float g_length_x = 0.64f; //< Domain x length (m)
constexpr float g_length_y = 0.48f;   //< Domain y length (m)
constexpr float g_length_z = 0.12f;   //< Domain z length (m)
...
constexpr int g_max_particle_num = 110000; // 8000000
...
constexpr int g_target_cells = 20000; //2500; //< Max nodes in grid-cell target

/// FEM vertice and element settings (for Lagrangian forces) (JB)
constexpr int g_max_fem_vertice_num = 10200; //20169; //915; //7260;  // Max no. of vertice on FEM mesh
constexpr int g_max_fem_element_num = 30720; //85671; //1810; //24551;  // Max no. of element in FEM mesh
constexpr int g_max_fem_element_bin = 30720; //85671; //1810; //24551;  // Max no. of element in FEM mesh
